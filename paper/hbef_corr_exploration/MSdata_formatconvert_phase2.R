...
###############################################
simple_chem_and_Q <- read_feather("./data/der_data/simple_chem_and_Q.feather")
full_chem_and_Q <- read_feather("./data/der_data/full_chem_and_Q.feather")
...
make_corr_plots("GN_alk") # for one solute 
